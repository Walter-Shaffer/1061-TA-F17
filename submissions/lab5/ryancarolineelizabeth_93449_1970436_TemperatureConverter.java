...
* This program asks the user for a temperature in Fahrenheit. After the user has inputted a temperature
* greater than -459.67s. If it is the program prompts the user to enter number 1-4 
* and the temperature scale to convert the temperature from Farhenheit to Kevlin, 
* Rankine, Reamur, or Celsius.
...
//			 System.exit(0);
		 ...
		 if (tempScale <= 0 || tempScale >= 5) {  // Second-if statement: Set a breakpoint here
