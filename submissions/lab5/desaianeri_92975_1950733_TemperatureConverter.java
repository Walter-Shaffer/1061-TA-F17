/**
  ...
  Author (new with debugged) : [Aneri Desai]
  Submission Date: 10/03/2017
  
  Purpose: In the lab we learned how to debugg the program using the eclipse debugger to find the 
  		   syntax error, logic error, and runtime error.
