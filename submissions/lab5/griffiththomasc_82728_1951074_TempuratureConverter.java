...
* Purpose: This program will receive a value from the user in Fahrenheit and will then prompt the user to choose what other temperature scales he would likee to see the equivilant of the temerature in fahrenheit 
*
