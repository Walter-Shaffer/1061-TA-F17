...
* Submission Date:  October 3rd, 2017
* Purpose: Takes a user inputed fahrenheit and converts it to either Kelvin, Reaumur, and Celsius
...
public class TemperatureConverter {
	...
	public static void main(String[] args) {
		// Declare named constants.
		 ...
		 fahrenheit =  keyboard.nextDouble();  // Breakpoint set   
	 
		 // Verify the user's input
		 if (fahrenheit < MIN_FAHRENHEIT) {   // first if-statement: breakpoint set
		 ...
		 if (tempScale < 1 && tempScale > 4) {  // Second-if statement: Set a breakpoint here
			 ...
			 if (tempScale == 1) { // Set a breakpoint here
				 ...
				 convertedDegrees = (fahrenheit - 32) * 4/9; // breakpoint set
				 tempScaleStr="Reaumur";
					 
			 } else {
				 convertedDegrees = (fahrenheit - 32) * 5/9; // breakpoint set
