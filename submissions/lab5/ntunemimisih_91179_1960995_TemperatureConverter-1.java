...
public class TemperatureConverter{
 ...
 public static void main(String[] args) {
	 ...
	 if (fahrenheit < MIN_FAHRENHEIT) {   // Set a breakpoint here, This was wrong because there was greater than sign, when there should be a less than. 
	 ...
	 if (tempScale < 1 || tempScale > 4) {  // Second-if statement: Set a breakpoint here
		 ...
		 if (tempScale == 1) { // Set a breakpoint here
			 convertedDegrees = (fahrenheit - MIN_FAHRENHEIT)*5.0/9; // added parenthesis, change addition to subtraction 
			 tempScaleStr="Kelvin"; 
		 } else if (tempScale == 2) { 
			 ...
			 convertedDegrees = (fahrenheit - 32.0) * 4.0/9; // Set a breakpoint here, added parenthesis, to calculate right
			 tempScaleStr="Reaumur"; // changed it from Rankine to Reaumur
				 
		 } else if (tempScale == 4){
			 convertedDegrees = (fahrenheit - 32.0) * 5.0/9; // Set a breakpoint here, switch the numbers divded
