...
*
* Purpose:
* The purpose of this program is to convert a temperture in
* Fahrenheit into either Kelvin, Rankine, Reaumur, or
* Celsius based on the input of the user.
*
              ...
              tempScale = keyboard.nextInt();
               ...
               if (tempScale < 1 || tempScale > 4) {  // Second-if statement: Set a breakpoint here
                    ...
                    if (tempScale == 1) { // Set a breakpoint here
                           convertedDegrees = (fahrenheit + 459.67) * (5.00/9.00);
                            tempScaleStr="Kelvin";
                           ...
                           tempScaleStr="Rankine";
                            ...
                            convertedDegrees = (fahrenheit - 32.00) * (4.00/9.00); // Set a breakpoint here
                           tempScaleStr="Reaumur";
                                 
                     } else {
                           convertedDegrees = (fahrenheit - 32.00) * (5.00/9.00); // Set a breakpoint here
