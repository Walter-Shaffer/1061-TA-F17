...
/**
* @formatter:off
* TemperatureConverter_test.java
* @author John Hollowell
* Submission Date: 10/3/2017
*
* @purpose Correcting the given file (see program's purpose below)
*
...
public class TemperatureConverter {
	...
	public static void main(String[] args) {
		...
		System.out.print (
			...
			"3. Reaumur \n"+
			"4. Celsius\n"+
			"Enter a temperature scale: ");//@formatter:on
		...
		if (tempScale >= 1 && tempScale <= 4) { // Second-if statement: Set a breakpoint here
			...
			if (tempScale == 1) { // Set a breakpoint here
				convertedDegrees = (fahrenheit - MIN_FAHRENHEIT) * (5 / 9.0);
				tempScaleStr = "Kelvin";
				...
				convertedDegrees = (fahrenheit - 32) * (4 / 9.0); // Set a breakpoint here
