 ...
 public static void main(String[] args) {
	 ...
	 if (tempScale < 1 || tempScale > 4) {  // Second-if statement: Set a breakpoint here
		 ...
		 if (tempScale == 1) { // Set a breakpoint here
			 convertedDegrees = fahrenheit + (MIN_FAHRENHEIT*5.00/9.00);
			 tempScaleStr="Kelvin"; 
		 } else if (tempScale == 2) { 
			 ...
			 convertedDegrees = (fahrenheit - 32) * (4.00/9.00); // Set a breakpoint here
			 tempScaleStr="Reaumur";
				 
		 } else {
			 convertedDegrees = (fahrenheit - 32) * (5.00/9.00); // Set a breakpoint here
