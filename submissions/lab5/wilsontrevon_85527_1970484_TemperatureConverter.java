...
* Submission Date: [10/6/2017]
*
* Purpose: Debug the program and get the program to compile and run properly.
*
 ...
 public static void main(String[] args) {
	 ...
	 if (tempScale < 1 && tempScale > 4) {  // Second-if statement: Set a breakpoint here
		 ...
		 if (tempScale == 1) { // Set a breakpoint here
			 ...
			 System.out.println(fahrenheit + " degrees Fahrenheit is " + convertedDegrees + " Kelvin");
 
		 } else if (tempScale == 2) { 
 			convertedDegrees = (fahrenheit - MIN_FAHRENHEIT);  
 			System.out.println(fahrenheit + " degrees Fahrenheit is " + convertedDegrees + " Rankine");
 			
		 } else if (tempScale == 3) { 
			 convertedDegrees = (fahrenheit - 32) * 4/9; // Set a breakpoint here
			 System.out.println(fahrenheit + " degrees Fahrenheit is " + convertedDegrees + " Reaumur");
				 
		 } else if (tempScale == 4){
			 convertedDegrees = (fahrenheit - 32) * 5/9; // Set a breakpoint here
			 System.out.println(fahrenheit + " degrees Fahrenheit is " + convertedDegrees + " Celsius");
		 }
	 }
 }
}
