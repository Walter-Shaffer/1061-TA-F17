...
* 
* Purpose: Computes groos and net pay based on various factors of employment.
* 
...
public class NetPay {
	public static void main(String[] args) {
		final double FEDERAL_TAX_PERCENT = 10.00; double STATE_TAX_PERCENT = 4.5;
		final double SS_PERCENT = 6.2; double MEDICARE_PERCENT = 1.45;
